...
**Status 2026-07-31: Phase 0 is COMPLETE** (see [docs/notes/phase-0-review.md](notes/phase-0-review.md)) **and Phase 1 is through WP-1.8: WP-1.0a, 1.1, 1.2, 1.3, 1.4, 1.4b, 1.5, 1.6a, 1.6b, 1.7 and 1.8 are merged** (PRs #11–23) — see [docs/notes/phase-1-midpoint.md](notes/phase-1-midpoint.md) for the mid-phase review. WP-1.9 (OIDC) is in review, and is the last WP before milestone M1. The critical path was/is:
