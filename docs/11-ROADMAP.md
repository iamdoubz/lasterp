...
**Status 2026-07-31: Phase 0 is COMPLETE** (see [docs/notes/phase-0-review.md](notes/phase-0-review.md)) **and Phase 1 is through WP-1.6a: WP-1.0a, 1.1, 1.2, 1.3, 1.4 and 1.4b are merged** (PRs #11–18) — see [docs/notes/phase-1-midpoint.md](notes/phase-1-midpoint.md) for the mid-phase review. WP-1.5 (web client v1, PR #19) and WP-1.6a (AR receipts + INV-F8, PR #20) are merged; WP-1.6b (reports + metrics + export) is in review. Next up: WP-1.7 (translation packs) / WP-1.8 (role dashboard packs), which build on the metrics layer. The critical path was/is:
