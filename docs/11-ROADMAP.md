...
**Status 2026-07-18: Phase 0 is COMPLETE** (see [docs/notes/phase-0-review.md](notes/phase-0-review.md)) **and Phase 1 is half done: WP-1.0a, 1.1, 1.2, 1.3, and 1.4 are merged** (PRs #11–16) — see [docs/notes/phase-1-midpoint.md](notes/phase-1-midpoint.md) for the mid-phase review. Next up: WP-1.4b (boot assembly — nothing is API-reachable until it lands), then WP-1.5. The critical path was/is:
