...
|---|---|---|---|
| Server language | **Go 1.26.5** (pinned; track latest stable patch) | Single static binary (self-hosting), goroutines handle 50k+ conns, fast compile = fast agent iteration, huge ecosystem, easy to write correctly | [ADR-001](adr/ADR-001-server-language.md) |
